...
//iMutableSupplyCap
{
    ...
    function increaseCapBy(
        uint256 amountBy
    )public view override onlyAdminOrOwner nonReentrant returns(
        uint256
    ){
    ...
    function decreaseCapBy(
        uint256 amountBy
    )external view override onlyAdminOrOwner nonReentrant
    returns(
        uint256
    ){
    ...
    function setCap(
        uint256 newCap
    )public view override onlyAdminOrOwner nonReentrant
    returns(
        uint256
    ){
