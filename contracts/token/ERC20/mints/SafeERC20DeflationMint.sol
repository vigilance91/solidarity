...
///
/// @title Safe ERC20 Deflation Mint
...
/// creating a deflationary token which can only go up in price as more tokens are progessively burnt over time
/// this is similar to having non-renewable resources with limited supply, which gradually reduces over time,
/// such as the amount of clean drinking water available, which only decreases in supply due to human contamination and pollution
/// or alternatively, gasoline or oil, which have a fixed available supply and can only ever (litterally) be burned as its used
///
