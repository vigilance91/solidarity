...
/// deploy gas cost: 1,180,304
///
contract AccessControlBatchedExternalImplementation is ERC165,
    ReentrancyGuard,
    ...
    iAccessControlBatchedMutable
{
    ...
    constructor(
        ...
        AccessControlMutableABC()
    {
        _registerInterface(type(iAccessControlBatchedMutable).interfaceId);
        //_registerInterface(type(iERC165).interfaceId ^ type(iAccessControlBatchedMutable).interfaceId);
    }
    ///
