...
//read-only/staticcall interface
//
library frameworkWhitelistView
{
    using logicConstraints for bool;
    using addressConstraints for address;
    ...
    using frameworkERC165 for address;
    using frameworkAccessControl for address;
    //using frameworkAccessControlView for address;
    
    string private constant _NAME = ' frameworkWhitelistView: ';
    string private constant _ERR_STR_ADRS = ', address: ';
    ...
    //bytes4 private constant IID_WHITELIST_VIEW = type(iWhitelistView).interfaceId;
    //bytes4 private constant IID_WHITELIST_MUTABLE = type(iWhitelistVMutable).interfaceId;
    bytes4 private constant _iWHITELIST_ID = type(iWhitelist).interfaceId;
    //bytes4 private constant _iACCESS_CONTROL_ID = type(iAccessControl).interfaceId;
    ...
    function isPermitted(
        ...
        //target.requireSupportsInterfaceWhitelistView();
        _requireSupportsInterface(target);
...
library frameworkWhitelistMutable
{
    using logicConstraints for bool;
    using addressConstraints for address;
    
    //using frameworkWhitelistInterfaceSupport for address;
    using frameworkERC165 for address;
    using frameworkAccessControl for address;
    
    string private constant _NAME = ' frameworkWhitelistMutable: ';
    string private constant _ERR_STR_TARGET = ', target: ';
    string private constant _ERR_STR_ADRS = ', address: ';
    
    //string internal constant STUB_PERMIT_ALL = 'permitAll()';
    //string internal constant STUB_REVOKE_ALL = 'revokeAll()';
    string internal constant _STUB_GRANT_PERMISSION = 'grantPermission(address)';
    string internal constant _STUB_REVOKE_PERMISSION = 'revokePermission(address)';
    //string internal constant _STUB_REVOKE_PERMISSION = 'transferPermission(address,address)';
    
    string internal constant _STUB_GRANT_PERMISSION_ARRAY = 'grantPermission(address[])';
    string internal constant _STUB_REVOKE_PERMISSION_ARRAY = 'revokePermission(address[])';
    //string internal constant _STUB_TRANSFER_PERMISSION = 'transferPermission(address[],address[])';
    ...
    {
        target.requireSupportsInterfaceWhitelistMutable();
...
library frameworkWhitelistDelegate
{
    using logicConstraints for bool;
    using addressConstraints for address;
    ...
    string private constant _NAME = ' frameworkWhitelistDelegate: ';
    ...
    )internal
    {
        ...
        (bool success, ) = target.delegatecall(
            abi.encodeWithSignature(
                frameworkWhitelistMutable.STUB_GRANT_PERMISSION,
                account
            )
        );
    ...
    )internal
    {
        ...
        (bool success, ) = target.delegatecall(
            abi.encodeWithSignature(
                frameworkWhitelistMutable.STUB_REVOKE_PERMISSION,
                account
            )
        );
