...
///
abstract contract AccessControlViewFullABC is AccessControl,    //AccessControlViewABC
    iAccessControlViewFull
{
    ...
    bytes4 internal constant _IID_ACCESS_CONTROL_VIEW_BATCHED = type(iAccessControlViewFull).interfaceId;
