...
///
contract AccessControlFull is AccessControlViewFullABC    //AccessControlMutableABC,
    //iAccessControlFull
{
    ...
    constructor(
        ...
        AccessControlViewFullABC()
    {
        //assert(_IID_ACCESS_CONTROL_VIEW_FULL ^ _IID_ACCESS_CONTROL_MUTABLE_FULL == _IID_ACCESS_CONTROL_FULL);
        
        //_registerInterface(_IID_ACCESS_CONTROL_MUTABLE_FULL);
        //_registerInterface(_IID_ACCESS_CONTROL_FULL);
    }
    ///
...
/// @dev deploy gas cost: 1,656,981 
contract TACF is AccessControlFull
{
    constructor(
    )public
        AccessControlFull(){
