...
library frameworkERC1820View
{
    ...
    */
    string private constant _NAME = ' frameworkERC1820View: ';
    
    bytes4 private constant _iERC1820_IMPLEMENTER_ID = type(iERC1820Implementer).interfaceId;
    bytes4 private constant _iERC1820_REGISTRY_ID = type(iERC1820Registry).interfaceId;
    //bytes4 private constant IID_ERC1820_VIEW = type(iERC1820View).interfaceId;
    ...
    function getInterfaceImplementer(
        ...
        return iERC1820Registry(target).getInterfaceImplementer(
            account,
            interfaceHash
        );
    }
    ///
    /// @dev Returns the implementer of `interfaceHash` for the calling address.
    /// If no such implementer is registered, returns the zero address.
    ///
    /// If `interfaceHash` is an {iERC165} interface id (i.e. it ends with 28 zeroes),
    ///`account` will be queried for support of it.
    ///
...
/*
library frameworkERC1820Mutable
{
    using logicConstraints for bool;
    using addressConstraints for address;
    ...
    string private constant _NAME = ' frameworkERC1820Mutable: ';
    
    bytes4 private constant _iERC1820_IMPLEMENTER_ID = type(iERC1820Implementer).interfaceId;
    bytes4 private constant IID_ERC1820_MUTABLE = type(iERC1820Mutable).interfaceId;
...
*/
/*
library frameworkERC1820Delegate
{
    using logicConstraints for bool;
    using addressConstraints for address;
